      ...
      <div className="relative max-w-[1000px] mx-auto">
        <div className={`relative flex flex-col lg:flex-row items-start gap-5 lg:gap-8 ${alignment === 'right' ? 'lg:flex-row-reverse' : ''}`}>
          ...
          <div className={`relative w-full lg:w-[42%] z-10 pt-3 lg:pt-7 ${alignment === 'left' ? 'lg:pr-4' : 'lg:pl-4'} ${alignment === 'left' ? '' : 'lg:text-right lg:items-end lg:flex lg:flex-col'}`}>
            ...
            <div className="mb-4">
              <p className="font-['Poppins',sans-serif] font-semibold text-[14px] text-[#3b82f6] tracking-[0.24px] leading-normal m-0">
                Featured Project
              </p>
            </div>
            ...
            {/* Project Title */}
            <div className="mb-5">
              <h3 className="font-['Poppins',sans-serif] font-semibold text-[26px] lg:text-[32px] text-[#ccd6f6] tracking-[0.4px] leading-[1.2] m-0">
                {title}
              </h3>
            </div>
          ...
          <div className={`relative w-full lg:w-[58%] z-20 ${alignment === 'left' ? '' : ''}`}>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 p-6">
                  <div className="font-['Poppins',sans-serif] font-medium text-[16px] text-[#ccd6f6] leading-[1.6]">
                    <p className="m-0">{description}</p>
                  </div>
                </div>
              </div>
              
              {/* Interaction Icons - Below glass card */}
              <div className={`flex items-center gap-4 mt-4 ${alignment === 'left' ? '' : 'justify-end'}`}>
                {githubUrl && (
                  <a 
                    href={githubUrl}
                    target="_blank"
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[11px] overflow-hidden shadow-xl bg-[#0a1929]">
                ...
                {/* Project Screenshot */}
                <div className="relative pt-6 overflow-hidden bg-[#0a1929]" style={{ minHeight: '300px' }}>
                  <img 
                    src={imageUrl} 
                    alt={`${title} preview`}
                    className="w-full h-full object-contain transition-all duration-500 ease-out hover:scale-105 cursor-pointer"
          ...
          <div className="lg:hidden w-full mt-6">
            ...
            {/* Interaction Icons - Below mobile card */}
